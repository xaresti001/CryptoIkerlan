...
public class CryptoController {
    ...
    @PostMapping("/ca")
    public ResponseEntity<CRT> generateCACertificate(@RequestBody CN cm) throws CertificateException, NoSuchAlgorithmException, IOException, SignatureException, NoSuchProviderException, InvalidKeyException, OperatorCreationException {
        System.out.println("Received CN: " + cm.getCommon_name());
        storedRootCertificateAndKeyPair = generateCACertificate(cm.getCommon_name());
    ...
    private RootCertificateAndKeyPair generateCACertificate(String commonName) throws NoSuchAlgorithmException, NoSuchProviderException, IOException, CertificateException, SignatureException, InvalidKeyException, OperatorCreationException {
        ...
        // Add basicConstraint as CA certificate
    ...
    private String serializePEMCertificate(X509Certificate certificate) throws CertificateEncodingException, IOException {
        ...
        return String.valueOf(byteOutputStream);
    }
